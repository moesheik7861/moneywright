...
export const ZA_TAX_YEARS: readonly ZaTaxYear[] = [
  {
    ...
    individualBrackets: [
      ...
      { threshold: 383100, rate: 0.31, base: 80078 },
      { threshold: 530200, rate: 0.36, base: 125709 },
      { threshold: 695800, rate: 0.39, base: 185325 },
      { threshold: 887000, rate: 0.41, base: 259893 },
      { threshold: 1878600, rate: 0.45, base: 666604 },
    ],
    primaryRebate: 17820,
    age65Rebate: 9765,
    age75Rebate: 3246,
