...
const INSTITUTIONS: Record<CountryCode, Institution[]> = {
  ...
  US: INSTITUTIONS_US,
  ZA: [
    { id: 'fnb', name: 'FNB', logo: '', website: 'https://www.fnb.co.za' },
    { id: 'standard_bank', name: 'Standard Bank', logo: '', website: 'https://www.standardbank.co.za' },
    { id: 'absa', name: 'Absa', logo: '', website: 'https://www.absa.co.za' },
    { id: 'nedbank', name: 'Nedbank', logo: '', website: 'https://www.nedbank.co.za' },
    { id: 'capitec', name: 'Capitec Bank', logo: '', website: 'https://www.capitecbank.co.za' },
    { id: 'discovery_bank', name: 'Discovery Bank', logo: '', website: 'https://www.discovery.co.za/bank' },
    { id: 'investec', name: 'Investec', logo: '', website: 'https://www.investec.com' },
    { id: 'tymebank', name: 'TymeBank', logo: '', website: 'https://www.tymebank.co.za' },
    { id: 'african_bank', name: 'African Bank', logo: '', website: 'https://www.africanbank.co.za' },
...
const INSURANCE_PROVIDERS: Record<CountryCode, Institution[]> = {
  ...
  ZA: [
    { id: 'discovery', name: 'Discovery', logo: '', website: 'https://www.discovery.co.za' },
    { id: 'momentum', name: 'Momentum', logo: '', website: 'https://www.momentum.co.za' },
    { id: 'sanlam', name: 'Sanlam', logo: '', website: 'https://www.sanlam.co.za' },
    { id: 'old_mutual', name: 'Old Mutual', logo: '', website: 'https://www.oldmutual.co.za' },
    { id: 'liberty', name: 'Liberty', logo: '', website: 'https://www.liberty.co.za' },
    { id: 'outsurance', name: 'OUTsurance', logo: '', website: 'https://www.outsurance.co.za' },
...
export const ACCOUNT_TYPES = {
  ...
  ZA: [
    ...
    { code: 'home_loan', label: 'Home Loan / Bond' },
    { code: 'vehicle_finance', label: 'Vehicle Finance' },
    { code: 'tfsa', label: 'Tax-Free Savings Account' },
    { code: 'retirement_annuity', label: 'Retirement Annuity' },
